...
# A Bedtools implementation is required to run parts of this

bedtoolsSystemCallErrorCode <- system('bedtools')
...
# section{Relationship to the gene models used in the 2011 paper}
